...
namespace JobSearch.API.Controllers
{
	...
	public class UsersController : Controller
	{
		...
		// http://seusite.com.br/api/users?email=EMAILPREENCHIDO&password=PASSWORDPREENCHIDO
		[HttpGet]
		...
		public IActionResult AddUser([FromBody]User user)
		{
			...
			return CreatedAtAction(nameof(GetUser), new { email = user.Email, password = user.Password}, user); // HTTP - 201
		}
